...
# The concrete KyaPay executor wrappers
from .kyapay_merchant_executor import KyaPayMerchantExecutor
...
def _create_routes(
    ...
    """
    Creates the routes for a single agent, applying the correct KyaPay wrapper.
    """
    ...
    # 2. Apply the concrete KyaPay merchant wrapper.
    agent_executor = KyaPayMerchantExecutor(agent_executor)
