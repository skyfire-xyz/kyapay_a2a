...
```
https://github.com/skyfire-ammar/skyfire-solutions-a2a-extension/v0.1
```
...
```json
{
  "capabilities": {
    "extensions": [
      {
        "uri": "https://github.com/skyfire-ammar/skyfire-solutions-a2a-extension/v0.1",
...
```
X-A2A-Extensions: https://github.com/skyfire-ammar/skyfire-solutions-a2a-extension/v0.1
```
